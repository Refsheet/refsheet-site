...
class SearchForm extends Component {
  ...
  handleSubmit(e) {
    ...
    const { forum: { slug: forumId }, history } = this.props
    const { search: { query: q } } = this.state
  ...
  render() {
    ...
    return (
      <form className={this.props.className} onSubmit={this.handleSubmit.bind(this)}>
        <input id={'forum_query'} type={'search'} name={'query'} value={ this.state.search.query } placeholder={t('forums.search_label', 'Search Posts...')} onChange={this.handleInputChange} />
