...
const Resolution = ({id, updateModeration, data, loading, error}) => {
  ...
  return <div>
    <a href='#' onClick={resolve('ignore')} className='btn grey block grey-text text-darken-2 margin-bottom--medium'>Ignore</a>
    <a href='#' onClick={resolve('dismiss')} className='btn green block white-text margin-bottom--medium'>No Issue</a>
    <a href='#' onClick={resolve('auto_resolve')} className='btn red block white-text'>Auto Resolve</a>
  </div>
}
    ...
    <Container className='margin-top--large'>
      <Row>
        ...
        <Col m={ 4 }>
          ...
          { moderation.comment && <p className='muted'>Comment: { moderation.comment }</p> }
          ...
          <Mutation mutation={ updateModeration }>
            { (resolve, data) =>
                <Resolution id={ moderation.id } updateModeration={ resolve } { ...data } />
            }
          </Mutation>
          }
          ...
          <div>
            ...
            <a href='#' onClick={next} className='btn block margin-top--medium white-text'>Next</a>
          </div>
          }
        </Col>
      </Row>
