...
const mediaTags = [
  'demon', 'imp', 'totally_cool_oc', 'tags_are_a_thing'
]

const ImageMeta = ({id, caption, caption_html, source_url, source_url_display}) => (
  <div className={'image-meta'}>
    <div className={'image-caption'}>
      <RichText contentHtml={caption_html} content={caption} placeholder={"No Caption"} />
    </div>
      ...
      { characterTags && <li>
        ...
        { characterTags.map((characterTag, i) => (
          <span key={characterTag.character.link}>
            <Link to={characterTag.character.link}>{ characterTag.character.name }</Link>
