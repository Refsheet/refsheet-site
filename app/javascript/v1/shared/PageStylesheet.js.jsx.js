  ...
  render() {
    ...
    for (let color in this.state.colorData) {
      ...
      for (let property of ['background-color', 'color', 'border-color']) {
        ...
        const moreClasses = otherClasses[className] != null ? otherClasses[className].join(', ') : undefined;
        if (moreClasses) { className += `, ${moreClasses}`; }
...
`;
    ...
    if ((this.state.colorData['card-background'] != null) && (this.state.colorData['card-background'] !== '')) {
