                    ...
                    <Column s={12} m={4}>
                        <div className='card card-light'>
                            ...
                            <div className='card-content'>
                                ...
                                <p>
                                    One link to your character's profile is worth more than a thousand words. Save time
                                    typing out descriptions, <em>send a Refsheet</em>.
                                </p>
                            </div>
                        </div>
                    </Column>
                    ...
                    <Column s={12} m={4}>
                        <div className='card card-light'>
                            ...
                            <div className='card-content'>
                                ...
                                <p>
                                    Figuring out what color to sample can be ambiguous. Remove the confusion and define
                    ...
                    <Column s={12} m={4}>
                        <div className='card card-light'>
                            ...
                            <div className='card-content'>
                                ...
                                <p>
                                    A lot of time and money went into your character's artwork. Share and show off your
                                    images!
                                </p>
                            </div>
                        </div>
