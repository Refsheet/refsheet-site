@Static.View = React.createClass
  ...
  componentDidMount: ->
    props = params: pageId: ( @props.match?.params.pageId || @props.location.pathname.replace(/^\//, '') )
  ...
  componentWillReceiveProps: (newProps) ->
    ...
    props = params: pageId: ( newProps.match?.params.pageId || newProps.location.pathname.replace(/^\//, '') )
