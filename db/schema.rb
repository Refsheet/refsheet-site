...
ActiveRecord::Schema.define(version: 20190422183620) do
  ...
  create_table "characters_profile_sections", force: :cascade do |t|
    ...
    t.index ["deleted_at"], name: "index_characters_profile_sections_on_deleted_at", using: :btree
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["guid"], name: "index_conversations_on_guid", using: :btree
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.index ["guid"], name: "index_notifications_on_guid", using: :btree
